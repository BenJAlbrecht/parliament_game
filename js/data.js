...
export const PARTIES = [
  {
    ...
    ideology: 'far-left',
    bio: {
      tag: 'Far-Left · Democratic Socialist',
  ...
  },
  {
    ...
    bio: {
      tag: 'Centre-Left · Social Democrat',
      summary: 'The historic party of organised labour, reformed into a broad progressive coalition.',
      history: 'Founded by trade union leaders at the turn of the twentieth century, the Social Democrats governed for most of the postwar decades and built the modern welfare state. A bruising stint in opposition during the 1990s forced a painful modernisation: the party shed its nationalisation commitments, embraced regulated markets, and repositioned itself as the party of public services and European integration. It remains the largest left-of-centre force, drawing support from public-sector workers, urban professionals, and minority communities.',
    },
  },
  {
    name: 'Renewal',
  ...
  },
  {
    ...
    bio: {
      tag: 'Centre-Right · Christian Democrat',
  ...
  },
  {
    ...
    ideology: 'far-right',
    bio: {
      tag: 'Far-Right · National-Conservative',
